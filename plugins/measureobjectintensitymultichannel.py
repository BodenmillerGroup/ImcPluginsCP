...
Select the objects whose intensities you want to measure.""",
    ...
    def prepare_settings(self, setting_values):
        ...
        See cellprofiler_core.modules.measureobjectsizeshape for an example.
        """
        #
    ...
    def run(self, workspace):
        ...
        for im in self.images:
            ...
            image = workspace.image_set.get_image(
                image_name.value, must_be_grayscale=False
            )
            ...
            for channel in range(nchan):
                for object_name in [obj.name for obj in self.objects]:
                    ...
                    for category, feature_name, measurement in (
                        ...
                        m.add_measurement(
                            object_name.value, measurement_name, measurement
                        )
