...
-  *%(CH_CHANNELS)s:* Many images contain color channels other than RGB
   ...
   have more than three channels."""
        ...
        self.grayscale_name = cps.text.ImageName(
...
"""
        ...
        self.red_name = cps.text.ImageName(
            "Name the output image",
            "OrigRed",
            doc="""\
*(Used only when splitting RGB images)*
...
"""
        ...
        self.green_name = cps.text.ImageName(
            "Name the output image",
            "OrigGreen",
            doc="""\
*(Used only when splitting RGB images)*
...
"""
        ...
        self.blue_name = cps.text.ImageName(
            "Name the output image",
            "OrigBlue",
            doc="""\
*(Used only when splitting RGB images)*
...
"""
        ...
        self.hue_name = cps.text.ImageName(
            "Name the output image",
            "OrigHue",
            doc="""\
*(Used only when splitting HSV images)*
...
"""
        ...
        self.saturation_name = cps.text.ImageName(
            "Name the output image",
            "OrigSaturation",
            doc="""\
*(Used only when splitting HSV images)*
...
"""
        ...
        self.value_name = cps.text.ImageName(
            "Name the output image",
            "OrigValue",
            doc="""\
*(Used only when splitting HSV images)*
...
Select the name of the output grayscale image.""",
    ...
    def channels_and_image_names(self):
        ...
        for channel in self.channels:
            ...
            result.append(
                (channel_idx, channel.image_name.value, channel.channel_choice.value)
            )
        return result
    ...
    def display_combine(self, workspace, figure):
        ...
        figure.subplot_imshow_color(
            0, 0, input_image, title="Original image: %s" % self.image_name
        )
