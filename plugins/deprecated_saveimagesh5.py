...
DEPRECATION_STRING = """
                This functionality has been integrated into the main SaveImages module
                thus this module is not working any more.\n
...
class Deprecated_SaveImagesH5(cellprofiler_core.module.Module):
